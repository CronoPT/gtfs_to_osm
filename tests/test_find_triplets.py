...
from fix_projections import find_triplets

class test_find_triplets(unittest.TestCase):
	...
	def test_vuurstaek_et_al_case(self):
		...
		triplets = find_triplets(self.Gg, self.gp_mappings)

		self.assertEqual(len(right_triplets), len(triplets))

		for triplet in triplets:
			self.assertIn(triplet, right_triplets)
